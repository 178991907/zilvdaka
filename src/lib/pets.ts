export type PetInfo = {
  id: string;
  name: string;
  getSvg: (blinkDuration?: number) => string;
};
...
<svg viewBox="0 0 200 200" class="w-full h-full">
  ...
  <style>
    .eye-1 { animation: blink ${blinkDuration}s infinite; }
    .eye-2 { animation: blink ${blinkDuration}s infinite 0.1s; }
  ...
  <g style="transform-origin: bottom center; animation: sway 8s ease-in-out infinite;">
  ...
  <g>
    ...
    <circle cx="83" cy="90" r="7" fill="black" class="eye-1" />
    <circle cx="117" cy="90" r="7" fill="black" class="eye-2" />
  </g>
  <path d="M 90,130 Q 100,145 110,130" stroke="white" stroke-width="4" fill="none" stroke-linecap="round" />
</svg>
    `,
  },
  {
...
<svg viewBox="0 0 200 200" class="w-full h-full">
  ...
  <g style="transform-origin: bottom center; animation: sway 7s ease-in-out infinite;">
  ...
  <g>
    ...
    <circle cx="100" cy="100" r="8" fill="black" class="eye-1" />
  </g>
  <path d="M 90,140 C 100,130 110,130 120,140" stroke="white" stroke-width="4" fill="none" stroke-linecap="round" />
</svg>
    `,
  },
  {
...
<svg viewBox="0 0 200 200" class="w-full h-full">
  ...
  <style>
    .eye-1 { animation: blink ${blinkDuration}s infinite; }
    .eye-2 { animation: blink ${blinkDuration}s infinite 0.2s; }
  ...
  <g style="transform-origin: bottom center; animation: sway 5s ease-in-out infinite;">
  ...
  <g>
    ...
    <circle cx="85" cy="110" r="5" fill="black" class="eye-1" />
    <circle cx="115" cy="110" r="5" fill="black" class="eye-2" />
  </g>
  <path d="M 95,140 C 100,150 105,150 110,140" stroke="black" stroke-width="3" fill="none" stroke-linecap="round" />
</svg>
    `,
  },
  {
...
<svg viewBox="0 0 200 200" class="w-full h-full">
  ...
  <style>
    .eye-1 { animation: blink ${blinkDuration}s infinite; }
    .eye-2 { animation: blink ${blinkDuration}s infinite 0.15s; }
  ...
  <ellipse cx="100" cy="180" rx="60" ry="10" fill="black" opacity="0.1" />
  <g style="transform-origin: bottom center; animation: jump 2s ease-in-out infinite;">
    <rect x="50" y="50" width="100" height="100" rx="20" fill="url(#bodyGradient4)" />
  </g>
  <g>
    <rect x="75" y="85" width="20" height="30" rx="5" fill="white" class="eye-1" />
    <rect x="105" y="85" width="20" height="30" rx="5" fill="white" class="eye-2" />
...
<svg viewBox="0 0 200 200" class="w-full h-full">
  ...
  <style>
    ...
    @keyframes blink { 0%, 98%, 100% { content: 'v'; } 99% { content: '—'; } }
  </style>
  <ellipse cx="100" cy="180" rx="70" ry="10" fill="black" opacity="0.05" style="animation: float 20s ease-in-out infinite;" />
  <g style="transform-origin: bottom center; animation: float 10s ease-in-out infinite;">
  ...
  <g>
    <text x="75" y="115" font-family="monospace" font-size="24" class="eye-1">^</text>
    <text x="105" y="115" font-family="monospace" font-size="24" class="eye-2">^</text>
  </g>
  <path d="M 85,130 Q 100,140 115,130" stroke="#94a3b8" stroke-width="3" fill="none" stroke-linecap="round" />
</svg>
    `,
  },
];
